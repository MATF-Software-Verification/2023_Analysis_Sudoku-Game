...
public class UserChoosingDifficulty { //class extracted from primary Main class
    ...
    public static int difficulty() { //if-else is refactored because of the class SudokuDisplay (which is refactored/extracted from Sudoku class)
        ...
        if (result!=0 && result!=-1){ //this if is added because of the variable result logic
            System.out.println(display.toString());
            usrSudoku = new Sudoku(display.getBoardAsString());
        }
        return result;
    }
}
